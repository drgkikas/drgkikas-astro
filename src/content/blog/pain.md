...
Το HF-rTMS M1 κατατάσσεται ως θεραπεία 3ης γραμμής για νευροπαθητικό πόνο στις γαλλικές κατευθυντήριες οδηγίες (Moisset et al. 2020). Στην Ελλάδα, το rTMS είναι ΕΓΚΕΚΡΙΜΕΝΗ θεραπεία για κατάθλιψη και OCD. Η εφαρμογή του στον πόνο γίνεται στα πλαίσια τεκμηριωμένης κλινικής πρακτικής.
...
Το Smart CNS Center (Ξενοφώντος 15Α, Σύνταγμα, Αθήνα) προσφέρει rTMS με εξοπλισμό MagVenture υπό την επίβλεψη του Dr. Πασχάλη Γκίκα. [Επικοινωνήστε μαζί μας](/epikoinonia/) για ραντεβού.
