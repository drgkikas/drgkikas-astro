---
title: "Cocaine and Stimulant Use Disorder"
description: "Cocaine use is a serious psychiatric disorder with a neurobiological basis. Psychiatrist Paschalis Gkikas provides specialized assessment and treatment in Athens."
icd10: "F14.1, F14.2"
faqs:
  - question: "Can someone stop cocaine alone?"
    answer: "In mild cases it may be possible, but the risk of relapse without support is high. Psychiatric assessment helps clarify underlying causes, such as coexisting disorders and triggers, and allows a realistic plan to be designed."
  - question: "How long does treatment last?"
    answer: "Active treatment usually lasts 3 to 12 months. The supportive phase may be long-term. Stable abstinence is built gradually — it is not a linear process."
  - question: "Is there a medication that stops cocaine craving?"
    answer: "There is no single medication, but combined pharmacological treatment tailored to the patient’s profile, together with psychotherapy, can show significant results. PGx analysis helps individualize treatment."
  - question: "What happens if other psychiatric problems coexist?"
    answer: "Coexisting bipolar disorder, ADHD or depression is common. Treatment must address both disorders simultaneously — treating only one of them increases relapse risk."
---
