---
title: "Ρόλος του DLPFC"
description: "DLPFC: Βασική περιοχή στόχος στο rTMS για την κατάθλιψη. Ρόλος στη ρύθμιση διάθεσης και εκτελεστικών λειτουργιών."
order: 20
---
...
### Κλινική Σημασία
Στόχευση: κλασικά με κανόνα 5 cm (5 cm anterior to motor hotspot), σύγχρονα με νευροπλοήγηση βάσει MRI για ακριβέστερη εντόπιση. Η ακριβής στόχευση στον προσδιορισμένος βάσει λειτουργικής διασύνδεσης DLPFC (anti-correlated με sgACC) συνδέεται με βελτιωμένα κλινικά αποτελέσματα.
