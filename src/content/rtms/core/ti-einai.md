...
description: "rTMS: η μη επεμβατική θεραπεία εγκεκριμένη από FDA και EMA για ανθεκτική κατάθλιψη, Μάθετε πώς λειτουργεί και κλείστε ραντεβού στην Αθήνα."
order: 10
---
...
### Σε ποιες νόσους μπορεί να χρησιμοποιηθεί το rTMS
