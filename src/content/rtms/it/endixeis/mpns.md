---
title: "mPNS: Stimolazione Magnetica dei Nervi Periferici"
...
L'obiettivo dell'mPNS non είναι quello di "riparare" meccanicamente un'articolazione, un tendine o un muscolo. L'obiettivo è aiutare a regolare i circuiti nervosi del dolore: dal nervo periferico al midollo spinale e, infine, al cervello. Puoi leggere di più su [come funziona la neuromodulazione tramite rTMS](/it/rtms/core/ti-einai).
...
![Come la stimolazione magnetica dei nervi periferici (mPNS) aiuta a regolare i circuiti nervosi del dolore](/images/mPNSen.webp)
...
1. **Riduzione del segnale doloroso**: La stimolazione dei nervi periferici può modificare l'input dei segnali di dolore al midollo spinale e al cervello. Ciò è correlato a meccanismi come l'attivazione di fibre sensoriali non dolorose e la riduzione dell'eccitazione eccessiva nei circuiti del dolore. [[5](#ref5)]
...
L'mPNS è più logica quando il dolore è di natura neuropatica, post-traumatica, post-operatoria o cronica e resistente. Leggi di più sul [trattamento del Dolore Cronico con rTMS](/it/rtms/endixeis/ponos).
...
L'mPNS e l'rTMS appartengono alla più ampia famiglia della neuromodulazione ma vengono applicati a diversi livelli del sistema nervoso. L'mPNS mira alla periferia, mentre l'rTMS mira principalmente ai circuiti cerebrali. Scopri di più su [Costi e Procedura rTMS](/it/rtms/core/kostos-kai-diadikasia).
